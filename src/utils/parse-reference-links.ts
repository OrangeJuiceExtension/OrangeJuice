...
export function parseReferenceLinks(activeItem: HTMLElement): ReferenceLinks[] {
	...
	const children = [...activeItem.children]; // Only collect Elements, not all nodes
	...
	for (const child of children) {
		...
		// The first word of the first text node of the <p> tag after trimming
		// trailing whitespace.
